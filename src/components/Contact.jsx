        ...
        <div className="bg-black/80 p-5 rounded-lg border border-white/10 shadow-[0_0_10px_rgba(255,255,255,0.08)]">
          ...
          <div className="space-y-3 text-gray-400 text-sm">
            ...
            <p className="flex items-center gap-2">
              ...
              <a href="https://www.linkedin.com/in/tarun-pratap-singh/" target="_blank" rel="noopener noreferrer" className="hover:underline text-blue-400">
                LinkedIn
              </a>
            </p>
            <p className="flex items-center gap-2">
              <Github className="w-4 h-4 text-white" />
              <a href="https://github.com/tarunpratapsingh" target="_blank" rel="noopener noreferrer" className="hover:underline text-gray-300">
                GitHub
              </a>
            </p>
          </div>
